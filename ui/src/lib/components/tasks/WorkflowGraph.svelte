...
<style>
  .workflow { flex: 1; overflow-y: auto; padding: 16px; display: flex; flex-direction: column; gap: 16px; }
  ...
  .name { font-size: 12px; font-weight: 600; color: var(--text-primary); margin-right: 4px; }
  .chip { padding: 2px 7px; border: 1px solid var(--border-default); border-radius: 10px; color: var(--text-secondary); font: 10px var(--font-mono); }
  ...
  .node { min-width: 0; padding: 10px; border: 1px solid var(--border-default); border-radius: var(--radius-md); background: var(--bg-inset); display: flex; flex-direction: column; gap: 6px; }
  .node.active { border-color: var(--accent-amber); box-shadow: 0 0 0 1px color-mix(in srgb, var(--accent-amber) 30%, transparent); }
  ...
  .node-head strong { flex: 1; font-size: 12px; color: var(--text-primary); }
  .dot { width: 7px; height: 7px; border-radius: 50%; background: var(--text-muted); }
  .active .dot { background: var(--accent-amber); } .verified .dot { background: var(--accent-green); } .failed .dot { background: var(--accent-red); }
  ...
  .edge.active { color: var(--accent-amber); border-color: var(--accent-amber); font-weight: 600; }
