...
| post-PR6 | **landed** — tool-calling, structured output, capability-registry routing | `voly/sdk/tools.py`, `voly/capability/routing.py`, `Agent`/`PlanRunner` default exec paths |
